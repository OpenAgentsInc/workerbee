...
# todo: stop guessing, use llama.cpp loader to get the right numbers
GGML_SIZE_MAP = {
    0: 32,
    1: 16,
    2: 4,
...
class GGUFReader:
    ...
    def read_kv_data(self):
        ...
        self.kv_size = self.fin.tell() - pos
    ...
    def vram_estimate(self):
        ...
        for ent in self.ti_info:
            ...
            dsize = GGML_SIZE_MAP[ent["dtype"]]/8.0
            tot_size += size * dsize * 1.4
